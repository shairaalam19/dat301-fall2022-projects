...
```{r}
boxplot(df$`hours-per-week`~df$`wage_below_orAbove_50k`, main = "Hours Per Week versus Wage", xlab = "Wage", ylab = "Hours Worked per Week", col = c("cornflowerblue", "darkolivegreen3"))
