...
boxplot(Hours~adultData$wage_below_orAbove_50k,horizontal=TRUE, col=c("green", "blue"), main="Hours Per Week based on Wage", xlab = "Wage", ylab = "Hours Worked per Week")
...
```{r}
marital_s = recode_factor(df$`marital-Status`, " Married-civ-spouse" = 1, " Divorced" = 2, " Never-married" = 3, " Separated" = 4, " Widowed" = 5, " Married-spouse-absent" = 6, " Married-AF-spouse" = 7, .default = 8)
